...
<head>
  ...
  <title>Add Solutions Book</title>
</head>
...
<h2 style="text-align: center; font-size:x-large;">Add Solution Book</h2>
<p></p>
<br>
  <form method="post" enctype="multipart/form-data">
   ...
   <input type="text" id="lname" name="url_download" placeholder="Add Solution Book URL..">
    ...
    <textarea id="subject" name="description" placeholder="Write Solution Description of Book.." style="height:200px"></textarea>
     <br>
     <input id="submit" type="submit" name = "submit_btn"  >
     <a id="back" href="admin_solbooks.php">back</a>
